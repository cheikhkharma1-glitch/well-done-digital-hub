...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Well Done Services Company — Solutions IT & digitales" },
      { property: "og:description", content: "Solutions IT sur mesure : web, logiciels, ERP, CRM, gestion scolaire, maintenance et réseaux." },
